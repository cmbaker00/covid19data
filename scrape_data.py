...
if __name__ == '__main__':
    data = CovidData('https://e.infogram.com/_/fGmCiqWT8M0AgX4fJOZd?src=embed',
                     "State and territory breakdowns of daily confirmed cases")
    data.download_and_save()

    data = CovidData('https://e.infogram.com/7ffaebfa-000b-459d-b592-af45f9f2d9b7?src=embed',
                     "Cumulative view of confirmed cases of COVID-19 in Australia")
    data.download_and_save()

    data = CovidData('https://e.infogram.com/_/3osqzRmYBiJsJafg79YC?src=embed',
                     "Total number of COVID-19 tests in each state or territory")
    data.download_and_save()

    data = CovidData('https://e.infogram.com/_/LSHmqF53MnDNvZBbtn8K?src=embed',
                     "Daily confirmed cases in NSW by transmission source")
    data.download_and_save()

    data = CovidData('https://infogram.com/1prln2g3rxxd9dtgjnyq961zm1am620p011',
                     "Daily confirmed cases in Victoria by transmission source")
    data.download_and_save()
    #
    data = CovidData('https://infogram.com/1p1jkdzd091j53amld9pk9ww6es6d1m7nnx',
                     "SA Cumulative view of transmission sources over time")
    data.download_and_save()

    data = CovidData('https://infogram.com/1pqmex9m36qznjfqjjd73n6p7gi0zgn013d',
                     "WA Cumulative view of unknown local and other transmission sources over time")
    data.download_and_save()

    data = CovidData('https://infogram.com/1px0k50nvw91yltqmwp706nnjqinrperkv7',
                     "Daily confirmed cases in Tasmania by transmission source")
    data.download_and_save()

    data = CovidData('https://infogram.com/1pkzv101w932qyh97g06g660x6u3jz3qkwx',
                     "Daily confirmed cases in ACT by transmission source")
    data.download_and_save()
    #
    data = CovidData('https://infogram.com/1p93l75n7ypl97b71lwp3j3rrrh377qw32m',
